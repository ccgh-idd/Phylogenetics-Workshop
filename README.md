...
Hand-on entry level introduction to phylogenetic methods

This entry-level introduction to phylogenetic methods demonstrates:

1. How phylogenetic trees are interpreted
2. How phylogenetic trees are constructed 
3. Assumptions of Phylogenetic methods and biological processes that complicate phylogenetic recontruction
